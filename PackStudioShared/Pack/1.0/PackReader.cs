...
namespace Pack.V1
{
    public class PackReader
    {
        ...
        [DllImport(Common.LibraryPath)] protected static extern bool getPackItemIndex(IntPtr packReader, string path, ref ulong index);
        [DllImport(Common.LibraryPath)] protected static extern uint getPackItemDataSize(IntPtr packReader, ulong index);
        [DllImport(Common.LibraryPath)] protected static extern string getPackItemPath(IntPtr packReader, ulong index);
        [DllImport(Common.LibraryPath)] protected static extern PackResult readPackItemData(IntPtr packReader, ulong index, ref IntPtr data, ref uint size);
        [DllImport(Common.LibraryPath)] protected static extern PackResult readPackPathItemData(IntPtr packReader, string path, ref IntPtr data, ref uint size);
        [DllImport(Common.LibraryPath)] protected static extern void freePackReaderBuffers(IntPtr packReader);
        [DllImport(Common.LibraryPath)] protected static extern PackResult unpackFiles(string filePath, ref ulong fileCount, bool printProgress);
