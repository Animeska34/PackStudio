...
namespace Pack.V2
{
    public class PackReader
    {
        ...
        //[DllImport(Common.LibraryPath)] protected static extern PackResult readPackPathItemData(IntPtr packReader, string path, ref byte[] data, ref uint size);
        ...
        /*
public PackResult ReadItemData(ulong index, ref byte[] data, uint threadIndex = 0)
{
    if (index >= ItemCount)
        throw new ArgumentOutOfRangeException(nameof(index));
    return readPackItemData(Handle, index, ref data, ref threadIndex);
}
*/
